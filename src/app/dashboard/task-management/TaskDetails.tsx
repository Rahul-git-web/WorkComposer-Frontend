                                        ...
                                        <div>
                                            ...
                                            <div className="relative mt-2">
                                                <input
                                                    ...
                                                    role="combobox"
                                                    type="text"
                                                    className={`w-full rounded-md px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6 ${isReadOnly ? "bg-gray-50 cursor-not-allowed" : "bg-white"
                                                ...
                                                <button
                                                    ...
                                                    className={`absolute inset-y-0 right-0 flex items-center pr-2 ${isReadOnly ? "cursor-not-allowed" : "cursor-pointer"
                                                        }`}
                                                >
                                                    <TbSelector className="col-start-1 row-start-1 size-5 self-center justify-self-end text-gray-500 sm:size-4" />
                                                </button>
