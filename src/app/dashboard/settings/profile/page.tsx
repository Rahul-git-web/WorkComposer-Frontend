                                    ...
                                    <div className='flex gap-3'>
                                        <div className='flex h-6 shrink-0 items-center'>
                                            <div className='group grid size-4 grid-cols-1'>
                                                ...
                                                <MdCheckBoxOutlineBlank className='pointer-events-none col-start-1 row-start-1 size-3.5 self-center justify-self-center stroke-white group-has-disabled:stroke-gray-950/25' />
                                            </div>
                                        </div>

                                        <div className='text-sm'>
                                            <label htmlFor="signOutAllDevices" className='font-medium text-gray-900'>Sign out from all devices</label>
                                        </div>
                                    </div>
                                    <div className='pt-4 text-center'>
