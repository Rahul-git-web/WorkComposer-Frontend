                                ...
                                <div>
                                    <table className='min-w-full table-fixed divide-y divide-gray-200' aria-label='User table'>
                                        ...
                                        <thead className='bg-gray-50 sticky top-0 shadow-sm border-b border-gray-200'>
                                            <tr>
                                                <th scope='col' className='w-1/3 py-3 pr-3 pl-6 text-left text-xs font-bold text-gray-700 uppercase tracking-wider'>User</th>
                                                ...
                                                <th scope='col' className='w-1/6 px-3 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden lg:table-cell'>Status</th>
                                                <th scope='col' className='py-3 pr-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider'>Invite Expiry</th>
                                                <th scope='col' className='py-3 pr-6 text-right text-xs font-bold text-gray-700 uppercase tracking-wider'>Actions</th>
                                            </tr>
                                        </thead>
                                                                    ...
                                                                    {user.status === "invited" && (
                                                                        <div className='relative'>
                                                                            <button onClick={() =>
                                                                                ...
                                                                                className='inline-flex items-center gap-1.5 bg-yellow-50 hover:bg-yellow-100 text-yellow-700 px-3 py-2 rounded-md text-xs font-medium border border-yellow-300 hover:border-yellow-400 transition-colors shadow-sm'>
