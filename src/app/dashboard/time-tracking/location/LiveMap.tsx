                            ...
                            <MarkerClusterGroup>
                                {locations.map((location: any) => (
                                    <Marker
                                        ...
                                        icon={createAvatarIcon(location.user.avatar)}
                                        eventHandlers={{
                                            click: async () => {
                                    ...
                                    >
                                        ...
                                        >
                                            {/* Header */}
                                            <div className="max-h-[280px] overflow-y-auto bg-white rounded-2xl">
                                                ...
                                                <div className="px-3 py-2">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3 border-b border-gray-200 py-2">
                                                    ...
                                                    <div className="mt-2 border-t border-gray-200 pt-2 space-y-2">
                                                        ...
                                                        <div className="flex justify-between">
                                                            ...
                                                            <span className="font-semibold">
                                                                {new Date(location.trackedAt).toLocaleString()}
                                                            </span>
                                                        </div>
