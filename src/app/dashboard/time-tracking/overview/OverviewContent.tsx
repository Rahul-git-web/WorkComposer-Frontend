          ...
          {loading ? (
            ...
            data.map((item) => {
              return (
                <div
                  key={item.id}
                  className="mb-4 rounded-xl border border-gray-100 p-3 sm:p-4 lg:p-6 hover:bg-gray-50 hover:shadow-sm transition-all duration-200"
                >
                  <div className="flex flex-col gap-4 rounded-lg p-2 -m-2">
