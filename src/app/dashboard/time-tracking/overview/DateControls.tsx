...
export default function DateControls({ date, setDate }: Props) {
      ...
      <div className="relative inline-block">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            title="Next"
          >
            <ChevronRight onClick={handleNext} className="w-4 h-4" />
          </button>
        </div>
      </div>

      <button 
        className="cursor-pointer inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-500 hover:text-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        title="Refresh"
      >
